...
R --slave -e 'install.packages(c("tidyverse", "doParallel", "nnet", "kernlab", "ranger", "xgboost", "dbarts", "devtools", "lme4", "earth", "titanic"))'
...
R --slave -e 'install.packages(c("tidymodels", "finetune"))'
...
R --slave -e 'install.packages(c("brulee"))'
